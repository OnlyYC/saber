...
public class ScheduleJobBean extends QuartzJobBean {
    private final Logger logger = LoggerFactory.getLogger(ScheduleJobBean.class);
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        //获取spring bean
        ScheduleJobHistoryService scheduleJobLogService = SpringContextUtils.getBean(ScheduleJobHistoryService.class);

        //数据库保存执行记录
        ScheduleJobHistoryDTO log = new ScheduleJobHistoryDTO();
        log.setScheduleJobId(scheduleJob.getId());
        log.setTitle(scheduleJob.getTitle());
        log.setDescription(scheduleJob.getDescription());
