...
import { ScheduleJobComponent } from 'app/entities/schedule-job/schedule-job.component';
...
describe('Component Tests', () => {
    describe('ScheduleJob Management Component', () => {
        let comp: ScheduleJobComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ScheduleJobComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.scheduleJobs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
